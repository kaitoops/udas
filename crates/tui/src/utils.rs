...
/// 2. Writes a crash dump to `~/.udas/crashes/<timestamp>-<name>.log`.
///
...
/// Write a panic dump file to `~/.udas/crashes/`.
///
...
/// panics, a crash dump is written to `~/.udas/crashes/` and the panic
