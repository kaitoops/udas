...
fn english(id: MessageId) -> &'static str {
    match id {
        ...
        MessageId::OnboardApiKeySavedHint => {
            "Saved to ~/.udas/config.toml so it works from any folder."
        }
        MessageId::OnboardApiKeyFormatHint => {
...
fn japanese(id: MessageId) -> Option<&'static str> {
    Some(match id {
        ...
        MessageId::OnboardApiKeySavedHint => {
            "~/.udas/config.toml に保存されるので、どのフォルダからでも有効になります。"
        }
        MessageId::OnboardApiKeyFormatHint => {
...
fn portuguese_brazil(id: MessageId) -> Option<&'static str> {
    Some(match id {
        ...
        MessageId::OnboardApiKeySavedHint => {
            "Salvo em ~/.udas/config.toml para funcionar em qualquer pasta."
        }
        MessageId::OnboardApiKeyFormatHint => {
...
fn spanish_latin_america(id: MessageId) -> Option<&'static str> {
    Some(match id {
        ...
        MessageId::OnboardApiKeySavedHint => {
            "Guardada en ~/.udas/config.toml para funcionar en cualquier carpeta."
        }
        MessageId::OnboardApiKeyFormatHint => {
