...
//!
//! Snapshots live in `~/.udas/snapshots/<project_hash>/<worktree_hash>/`.
...
///
/// Returns `~/.udas/snapshots/<project_hash>/<worktree_hash>/`. The
...
/// Used by tests so we never touch the user's real `~/.udas/`.
